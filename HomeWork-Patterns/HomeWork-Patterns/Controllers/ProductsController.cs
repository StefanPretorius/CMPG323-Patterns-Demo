...
using HomeWork_Patterns.Repository;

namespace HomeWork_Patterns.Controllers
{
    public class ProductsController : Controller
    {
        private readonly CMPG_323_Patterns_HomeworkContext _context;

        public ProductsController(CMPG_323_Patterns_HomeworkContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            if (id == null || productRepository == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'CMPG_323_Patterns_HomeworkContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
